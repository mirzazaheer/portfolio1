...
const About: React.FC = () => {
  ...
  return (
    <section id="about" className="py-16 lg:py-24 bg-gradient-to-b from-slate-950 to-slate-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start">
          ...
          <div className="space-y-8">
            <div className="group relative bg-slate-900/50 backdrop-blur-xl rounded-3xl p-8 border border-slate-800/50 hover:border-slate-700/50 transition-all duration-500">
              ...
              <div className="relative z-10">
                <h3 className="text-2xl lg:text-3xl font-bold text-white mb-6">Professional Journey</h3>
            ...
            <div className="group relative bg-slate-900/50 backdrop-blur-xl rounded-3xl p-8 border border-slate-800/50 hover:border-slate-700/50 transition-all duration-500">
              ...
              <div className="relative z-10">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h3 className="text-2xl lg:text-3xl font-bold text-white">Education Excellence</h3>
                </div>
                <div className="space-y-6">
                  <div className="p-6 bg-slate-800/30 rounded-2xl border border-slate-700/30">
                    <h4 className="text-lg lg:text-xl font-semibold text-cyan-400 mb-2">M.Tech – Data Science & Engineering</h4>
                  ...
                  <div className="p-6 bg-slate-800/30 rounded-2xl border border-slate-700/30">
                    <h4 className="text-lg lg:text-xl font-semibold text-blue-400 mb-2">B.Tech – Software Engineering</h4>
                    <div className="flex flex-col sm:flex-row sm:items-center gap-2 text-slate-300">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {highlights.map((highlight, index) => {
              ...
              return (
                <div 
                  key={index}
                  className="group relative bg-slate-900/50 backdrop-blur-xl rounded-3xl p-6 lg:p-8 border border-slate-800/50 hover:border-slate-700/50 transition-all duration-500 hover:transform hover:scale-105"
                >
                  <div className={`absolute inset-0 bg-gradient-to-br ${highlight.gradient} opacity-0 group-hover:opacity-5 rounded-3xl transition-opacity duration-500`}></div>
                  <div className="relative z-10">
                    <div className={`flex items-center justify-center w-16 h-16 bg-gradient-to-br ${highlight.gradient} bg-opacity-10 rounded-2xl mb-6 group-hover:scale-110 transition-transform duration-300`}>
                      <Icon className={`w-8 h-8 bg-gradient-to-br ${highlight.gradient} bg-clip-text text-transparent`} />
                    </div>
                    <h3 className="text-xl lg:text-2xl font-bold text-white mb-4 group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-cyan-400 group-hover:to-blue-500 transition-all duration-300">
                      {highlight.title}
                    </h3>
                    <p className="text-slate-400 leading-relaxed text-sm lg:text-base">{highlight.description}</p>
                  </div>
                </div>
              );
            })}
