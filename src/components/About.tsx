          ...
          <div className="space-y-6 sm:space-y-8">
            <div className="group relative bg-slate-900/50 backdrop-blur-xl rounded-2xl sm:rounded-3xl p-6 sm:p-8 border border-slate-800/50 hover:border-slate-700/50 transition-all duration-500">
              ...
              <div className="relative z-10">
                ...
                <p className="text-slate-300 leading-relaxed mb-4 sm:mb-6 text-sm sm:text-base lg:text-lg text-left sm:text-justify">
                ...
                <p className="text-slate-300 leading-relaxed text-sm sm:text-base lg:text-lg text-left sm:text-justify">
              ...
              <div className="relative z-10">
                ...
                <div className="space-y-4 sm:space-y-6">
                  <div className="p-4 sm:p-6 bg-slate-800/30 rounded-xl sm:rounded-2xl border border-slate-700/30">
                    <h4 className="text-base sm:text-lg lg:text-xl font-semibold text-cyan-400 mb-2">M.Tech – Data Science & Engineering</h4>
                    <div className="flex flex-col sm:flex-row sm:items-center gap-2 text-slate-300 text-sm sm:text-base">
                  ...
                  <div className="p-4 sm:p-6 bg-slate-800/30 rounded-xl sm:rounded-2xl border border-slate-700/30">
                    <h4 className="text-base sm:text-lg lg:text-xl font-semibold text-blue-400 mb-2">B.Tech – Software Engineering</h4>
                    <div className="flex flex-col sm:flex-row sm:items-center gap-2 text-slate-300 text-sm sm:text-base">
            ...
            {highlights.map((highlight, index) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="relative z-10">
                    <div className={`flex items-center justify-center w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-br ${highlight.gradient} bg-opacity-10 rounded-xl sm:rounded-2xl mb-4 sm:mb-6 group-hover:scale-110 transition-transform duration-300`}>
                    ...
                    <p className="text-slate-400 leading-relaxed text-xs sm:text-sm lg:text-base text-left">{highlight.description}</p>
                  </div>
                </div>
              );
            })}
